...
class _Settings02WidgetState extends State<Settings02Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Settings02'});
            ...
            desktop: false,
              ...
              ? AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'SETTINGS02_arrow_back_rounded_ICN_ON_TAP');
          ...
          body: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'hbgqpbk7' /* Please evaluate your options b... */,
                  ),
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('SETTINGS02_PAGE_LOG_OUT_BTN_ON_TAP');
